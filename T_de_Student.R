...
# Executar o teste t de Student para comparar as metodologias "Adhoc" e "SonarQube"
resultado_t_test <- t.test(Erros ~ Metodologia, data = dados)

# Mostrar os resultados do teste t de Student
print(resultado_t_test)

# Salvar o valor p do teste t em uma variável
valor_p <- resultado_t_test$p.value
cat("Valor p do Teste t de Student:", round(valor_p, 3), "\n")

# Se necessário, você pode salvar os resultados em uma tabela ou arquivo
